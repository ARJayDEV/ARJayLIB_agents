...
arjay_collectGarbage = 
{
	...
	// debug ----------------------------------------------------------------------------------------------------------------------------
	//if(arjay_debug && arjay_debugLevel > 2) then {["--- GC - queued objects %1", (arjay_garbageCollectionObjects select 1)] call arjay_dump;};
	// debug ----------------------------------------------------------------------------------------------------------------------------
		...
		if!(isNull _target) then {			
			{
				...
				// debug ----------------------------------------------------------------------------------------------------------------------------
				//if(arjay_debug && arjay_debugLevel > 2) then {["--- GC - player to object [%1] distance [%2 meters]", vehicleVarName _target, _distance] call arjay_dump;};
				// debug ----------------------------------------------------------------------------------------------------------------------------
	...
	// do the garbage collection
	{
		...
		if((count units _targetGroup) == 1) then
		{
		...
		// debug ----------------------------------------------------------------------------------------------------------------------------
		//if(arjay_debug && arjay_debugLevel > 1) then {["--- GC - object garbage collected %1", _targetName] call arjay_dump;};
		// debug ----------------------------------------------------------------------------------------------------------------------------
